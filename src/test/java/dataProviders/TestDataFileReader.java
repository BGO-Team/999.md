...
public class TestDataFileReader {
    ...
    public static String getApplicationUrl() {
        ...
        if (url != null) return url;
            ...
            throw new RuntimeException("Application Url not specified in the test.properties file for the Key:url");
    }
    ...
    public static String getUserPassword(String user) {
        ...
        if (password != null) return password;
            ...
            throw new RuntimeException("Application password not specified in the test.properties file for the Key:password");
    }
